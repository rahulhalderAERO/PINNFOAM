                  ...
                  if hasattr(condition, 'function'):
                    ...
                    for function in condition.function:                                                
                        ...
                        for i in range(0,200-1,5):
                            ...
                            if i == 0: 
                              dmulty_Mat = torch.mm(Derivative_m1[k*1200:(k+1)*1200,:], predicted[i,:].reshape(-1,1)) + torch.mm(Derivative_current[k*1200:(k+1)*1200,:],predicted[i+1,:].reshape(-1,1))
                            else: 
                              dmulty_new = torch.mm(Derivative_m1[k*1200:(k+1)*1200,:], predicted[i,:].reshape(-1,1)) + torch.mm(Derivative_current[k*1200:(k+1)*1200,:],predicted[i+1,:].reshape(-1,1))
